...
import { LayoutDashboard, Users2, Bell, ScrollText, BarChart3, Plug, Rocket, History, Settings } from 'lucide-react'
...
export const adminNav = [
  ...
  { to: '/admin/changelog', label: 'Console Changelog', icon: History },
